 ...
 */
public class SCIMRITestListener
       implements ITestListener
{
  ...
  /**
   * Creates a new instance of this SCIM SDK test listener.
   */
  public SCIMRITestListener()
  {
  ...
  public synchronized void onTestStart(final ITestResult result)
  {
    ...
    // Make sure that the test class is a subclass of SCIMRITestCase
    Class<?> c = testClass.getRealClass();
    if (! (SCIMRITestCase.class.isAssignableFrom(c)))
    {
      System.err.println();
      System.err.println("WARNING:  Test class " + lastClass +
           " does not extend SCIMRITestCase");
      System.err.println();
    }
