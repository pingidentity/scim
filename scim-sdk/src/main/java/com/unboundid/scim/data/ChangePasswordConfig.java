...
public class ChangePasswordConfig
{
   ...
   * to/from <code>ChangePasswordConfig</code> instances.
   */
  public static final AttributeValueResolver<ChangePasswordConfig>
      CHANGE_PASSWORD_CONFIG_RESOLVER =
      new AttributeValueResolver<ChangePasswordConfig>()
      {
        /**
         * {@inheritDoc}
         */
        @Override
        public ChangePasswordConfig toInstance(final SCIMAttributeValue value) {
        ...
        public SCIMAttributeValue fromInstance(
            ...
            final ChangePasswordConfig value)
   ...
   *
   * @param supported  Specifies whether the Change Password operation is
   *                   supported.
   */
  ...
  public boolean equals(final Object o)
  {
    ...
    final ChangePasswordConfig that = (ChangePasswordConfig) o;
  ...
  public String toString()
  {
    ...
    sb.append("ChangePasswordConfig");
