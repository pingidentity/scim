...
public class UserResource
{
  ...
  private Response getUser(final MediaType mediaType, final String userID)
  {
    ...
    if (origin != null)
    {
      builder.header(HEADER_NAME_ACCESS_CONTROL_ALLOW_ORIGIN, origin);
    }
    builder.header(HEADER_NAME_ACCESS_CONTROL_ALLOW_CREDENTIALS,
                            ...
                            final InputStream inputStream)
  {
    ...
    final Marshaller marshaller;
    responseBuilder.type(produceMediaType);
    if (produceMediaType.equals(MediaType.APPLICATION_JSON_TYPE))
    {
      marshaller = marshalContext.marshaller(
          com.unboundid.scim.marshal.Context.Format.Json);
    }
