...
public final class Version
{
   ...
   * value is "UnboundID SCIM SDK for Java".
   */
  ...
  /**
   * The major version number for the SCIM SDK.  For this build, the value is
   * 1.
   */
  ...
  /**
   * The minor version number for the SCIM SDK.  For this build, the value is
   * 0.
   */
  ...
  /**
   * The point version number for the SCIM SDK.  For this build, the value is
   * 0.
   */
  ...
  /**
   * The version qualifier string for the SCIM SDK.  It will often be a
   ...
   * For this build, the value is "20110602220548Z".
   */
  public static final String BUILD_TIMESTAMP = "20110602220548Z";
   ...
   * For this build, the value is "{not-applicable}".
   */
   ...
   * build time.  For this build, the value is -1.
   */
   ...
   * "UnboundID SCIM SDK for Java 1.0.0".
   */
